...
**Description:**  
When using flashbacks, minisectors may be overwritten or counted twice if lap time and lap distance do not rewind
consistently.
...
**Description:**  
Due to the maximum 60 Hz UDP tick rate of the F1 games, minisector times cannot be measured with true millisecond
precision.  
...
**Description:**  
Since F1 2020 does not provide real sector start distances, sectors are approximated as thirds of the total track
length.
